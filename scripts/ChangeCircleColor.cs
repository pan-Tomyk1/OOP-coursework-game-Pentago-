...
public class ChangeCircleColor : MonoBehaviour
{
    ...
    void Awake(){
        //отримуємо збережені кольори кульок для гравців, при першому запуску гри
        //за замовчуванням буде чорний та білий
        ...
        //паршу кольори з PlayerPrefs-a в кольори для обох гравців
