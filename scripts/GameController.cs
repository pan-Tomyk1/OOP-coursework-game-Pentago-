...
public class GameController : MonoBehaviour
{
    ...
    private static CircleNumber[,] staticGameField = new CircleNumber[arrayDemension,arrayDemension];
    ...
    private void makeStaticGameField(){
        for(int i=0;i<arrayDemension; i++){
            for(int j=0;j<arrayDemension; j++){
            staticGameField[i,j]=gameField[i,j];
        }
        }
    }
    
    // public static CircleNumber[,] getGameField(){
    //     endPanel.turnOnPanel("Game interrupted");
    //     return staticGameField;
    // }
    private void Start() {
...
private void turnOffRotateButtons(){
    ...
    private void Print2DArray(){
        ...
        for(int i=0; i<arrayDemension;i++){
            for(int j=0; j<arrayDemension;j++){
                Debug.Log(gameField[i,j].ToString());
    ...
    public void SaveUnfinishedGame(){
        gameSaver.saveGame(gameField,"The game is unfinished");
    }
